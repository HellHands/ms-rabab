...
<br><br>
    ...
    <script>
		...
		function addRow(tableID) {
			...
			$(".datepick, #teachers_dob").datepicker({	format: 'yyyy-mm-dd', endDate: '1996-12-31' });
			$(".datepick3, #teachers_doe").datepicker({	format: 'yyyy-mm-dd', endDate: '2015-10-31' });
		...
		$(function() {
			$('#Asc201516AddForm').on('keyup keypress', function(e) {
			  var keyCode = e.keyCode || e.which;
			  if (keyCode === 13) { 
			    e.preventDefault();
			    return false;
			...
			$("#Asc201516Schoolbuildingowners").change(function(){
				...
				if (choice == 2) {
					...
					onbsid.removeAttr('required', 'required');
					onbsid.attr('disabled', 'disabled');

					obs.attr('style', 'display: none;');
					obsid.removeAttr('required', 'required');
					obsid.attr('disabled', 'disabled');

					obss.attr('style', 'display: block;');
					obssid.attr('required', 'required');
					obssid.removeAttr('disabled', 'disabled');

				}else if(choice == 4){

					obss.attr('style', 'display: none;');
					obssid.removeAttr('required', 'required');
					obssid.attr('disabled', 'disabled');
			...
			$("#Asc201516SchReceivedGirlsStipend").change(function(){
				...
				if(choice == 1)
				{
					...
					$("#Asc201516SchReceivedGirlsStipendEnrollment").attr('disabled', 'disabled');
					$("#Asc201516SchReceivedGirlsStipendEligible").attr('disabled', 'disabled');
					$("#Asc201516SchReceivedGirlsStipendReceived").attr('disabled', 'disabled');
				}
			});
			...
			$("#Asc201516DsiSchMedium0").change(function(){
				if(document.getElementById("Asc201516DsiSchMedium0").checked){
					...
					$("#Asc201516DsiEnrollmentUrdu").attr('disabled', 'disabled');	
			...
			$("#Asc201516DsiSchMedium1").change(function(){
				if(document.getElementById("Asc201516DsiSchMedium1").checked){
					...
					$("#Asc201516DsiEnrollmentSindhi").attr('disabled', 'disabled');	
			...
			$("#Asc201516DsiSchMedium2").change(function(){
				if(document.getElementById("Asc201516DsiSchMedium2").checked){
					...
					$("#Asc201516DsiEnrollmentEnglish").attr('disabled', 'disabled');	
			...
			$('#Asc201516SbiSchoolBuildingOtherThanLearning').change(function(){
				...
				{ 
					...
					$('#Asc201516SbiSchoolBuildingOtherThanLearningRooms').attr('disabled', 'disabled');
					sbi_other_building_specify
				}else if(choice == 0){
					$('#other_than_learning_rooms_count').attr('style', 'display: none');
					$('#Asc201516SbiSchoolBuildingOtherThanLearningRooms').attr('disabled', 'disabled');
					$('#purpose_other_than_learning').attr('style' , 'display: none');
					$('#Asc201516SbiPurposeOtherThanLearningSpecify').attr('disabled', 'disabled');
				}else{
					$('#purpose_other_than_learning').attr('style' , 'display: none');
					$('#Asc201516SbiPurposeOtherThanLearningSpecify').attr('disabled', 'disabled');					
			...
			$('#Asc201516SchBranched').change(function(){
				...
				{	
					...
					$('#Asc201516SchBranchedMainSchoolName').attr('disabled', 'disabled');
										
					$('#consolidated_main_school_semis').attr('style', 'display: none');
					$('#Asc201516SchBranchedMainSchoolSemis').attr('disabled', 'disabled');
			...
			$("#Asc201516EleClassEceBoysEnrollment, #Asc201516EleClassKatchiBoysEnrollment, #Asc201516EleClassOneBoysEnrollment, #Asc201516EleClassTwoBoysEnrollment, #Asc201516EleClassThreeBoysEnrollment, #Asc201516EleClassFourBoysEnrollment, #Asc201516EleClassFiveBoysEnrollment, #Asc201516EleClassSixBoysEnrollment, #Asc201516EleClassSevenBoysEnrollment, #Asc201516EleClassEightBoysEnrollment").keyup(function(){
				...
				if(boys_n_girls > total_enrollment){					
					...
					$("#ele_enr_table").css({"background-color":"#fff", "color":"#000"});	
				}
			...
			$(".sec-boys-enrollment-calc").keyup(function(){
				...
				if(boys_n_girls > total_enrollment){					
					...
					$("#sec_enr_table").css({"background-color":"#fff", "color":"#000"});	
				}
			...
			$(".hsec-boys-enrollment-calc").keyup(function(){
				...
				if(boys_n_girls > total_enrollment){					
					...
					$("#hsec_enr_table").css({"background-color":"#fff", "color":"#000"});
				}
			...
			$("#Asc201516SchAdopted").change(function(){
				...
				if(choice == 1)
				{
					...
					$("#Asc201516SchAdopterName").attr('disabled','disabled');
				}
			});
			...
			$("#Asc201516DsiSneApproved").change(function() {
				...
				if(choice == 1){
					...
					$("#sne_posts_div").attr('style', 'display: block'); 
					$("#Asc201516DsiSneTeachingSanctioned").attr('disabled', 'disabled');
					$("#Asc201516DsiSneNonteachingSanctioned").attr('disabled', 'disabled');
					...
					$("#Asc201516DsiSneTeachingSanctioned").attr('disabled', 'disabled');
					$("#Asc201516DsiSneNonteachingSanctioned").attr('disabled', 'disabled');
					$("#Asc201516DsiSneTeachingWorking").attr('disabled', 'disabled');
					$("#Asc201516DsiSneNonteachingWorking").attr('disabled', 'disabled');
					$("#Asc201516DsiSneTeachingVacant").attr('disabled', 'disabled');
					$("#Asc201516DsiSneNonteachingVacant").attr('disabled', 'disabled');
			...
			$("#Asc201516SchUpgraded").change(function(){
				...
				if(choice == 1){
					if(levelSelected == 1){
						...
						upgradeSelect.html("<option>Select Level first</option>");
					}
			...
			$("#Asc201516DsiSchAdministration").change(function(){
				...
				if(choice == 5){
					...
					$("#Asc201516DsiSchAdministrationSpecify").attr('disabled', 'disabled');
					$("#Asc201516DsiSchAdministrationSpecify").val('');
					$("#Asc201516DsiSchAdministrationSpecify").attr('value', '');
				}
