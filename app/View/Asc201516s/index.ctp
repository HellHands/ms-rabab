...
<br><br>
<center><h3>Welcome <strong><?= $this->Session->read('Auth.User.name'); ?></strong> to Data Input Operator (DIO) Dashboard!</h3></center>
...
<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#filled" aria-controls="filled" role="tab" data-toggle="tab">In Process Forms</a></li>    
    <li role="presentation"><a href="#finalized" aria-controls="finalized" role="tab" data-toggle="tab">Filled Forms</a></li>    
  </ul>
				...
				foreach ($schools_filled_n_notfinalized as $key => $value) { ?>
					<tr>	
						...
						<td class="actions">
							...
							<?= $this->Html->link(__('Edit'), array('action' => 'edit_asc201516', $value['Asc201516']['school_semis_code']), array(
							'class' => 'btn btn-primary', 'style' => 'margin-top: 0;')); ?>
					
							<?= $this->Html->link(__('Finalize'), array('action' => 'finalize_dio', $value['Asc201516']['school_semis_code'], 1), array('class' => 'btn btn-primary', 'style' => 'margin-top: 0;'));?>
