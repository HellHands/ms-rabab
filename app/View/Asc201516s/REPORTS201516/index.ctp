              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li>
                      <?= $this->Html->link('Dashboard', array('controller' => 'reports201516', 'action' => ''));?>
                    </li>
                    <li>
                      <?= $this->Html->link('Dashboard 2014', array('controller' => 'reports201516', 'action' => '2k14')); ?>
                    </li>
                    <li>
                      <?= $this->Html->link('Dashboard 2013', array('controller' => 'reports201516', 'action' => '2k13')); ?>
                    </li>
                    <li>
                      <?= $this->Html->link('Dashboard 2012', array('controller' => 'reports201516', 'action' => '2k12')); ?>
                    </li>
                  </ul>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="<?= $this->webroot;?>images-reporting/img.jpg" alt=""><?= $name; ?>
                  <span class=" fa fa-angle-down"></span>
                </a>
                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                  <li><a href="javascript:;">  Profile</a>
                  </li>                  
                  <li><a href="../users/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                  </li>
                </ul>
              </li>
