		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				...
				<div class="row">
				  	...
				  	<div class="form-group col-md-4" id="closure_major_reason_specify_div" style="display: none;">
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<div class="row">
			  	...
			  	<div class="row" id="sne_posts_div" style="display: none;"> 
					<div class="form-group col-md-2">
			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-2">
				  	...
				  	<div class="form-group col-md-2" style="display: none;" id="sch_admin_specify_div">
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<div class="row">
			  	...
			  	<div class="row" id="campus_merge_no_div" style ="display: none;" >
					<div class="form-group col-md-4">
			...
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-2">
				  	...
				  	<div class="form-group col-md-2" id="other_building_semiscode_specify" style="display: none;">
				  	...
				  	<div class="form-group col-md-2" id="other_building_specify" style="display: none;">
				  	...
				  	<div class="form-group col-md-2" id="other_nobuilding_specify" style="display: none;">
				...
				<div class="row">
					...
					<div class="form-group col-md-2" id="other_than_learning_rooms_count" style="display: none;">
					...
					<div class="form-group col-md-2" id="purpose_other_than_learning" style="display: none;">
				...
				<div class="row">
					<div class="form-group col-md-2">
						<?= $this->Form->input('bfi_school_waterfacility', array(
							...
							'options' => array('1' => '1 = Yes', '2' => '2 = No'),
							'empty'   => array('0' => '0 = Choose'),
							'class'   => 'form-control'
							)); 
						?>
					</div>
...
<div id="page2" class="hide">
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				...
				<div class="row">				
					...
					<div id="elem_tbl" style="display: none;">
						<div class="form-group col-md-12">
						...
						<div class="col-md-12">
							<table class="table table-condensed table-bordered" id="ele_enr_table" style='padding-left: 0; padding-right: 0; text-align:center;'>
								<tr>
									<th>Class</th>
									<th>ECE</th>
									<th>Katchi</th>
								...
								<tr>
									...
									<td>			
										<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
											...
											'class'      => 'form-control ele-boys-enrollment'
											)); ?>	
										</div>				
									</td>
								...
								<tr>
									...
									<td>			
										<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
											...
											'class'      => 'form-control ele-girls-enrollment'
											)); ?>	
										</div>				
									</td>
					...
					<div id="sec_tbl" style="display: none;">
						...
						<div class="col-md-12">
							<table class="table table-condensed table-bordered" id="sec_enr_table" style='padding-left: 0; padding-right: 0; text-align:center;'>
								<tr>
									<th>Class</th>
					...
					<div id="hsec_tbl" style="display: none;">
						...
						<div class="col-md-12">
							<table class="table table-condensed table-bordered" id="hsec_enr_table"style='padding-left: 0; padding-right: 0; text-align:center;'>
								<tr>
									<th>Class</th>
							...
							<tr>
								...
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_four_boys',
								...
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_five_boys',
										'class' => 'form-control repeaters-boys-calc'
										)); ?>
									</div>
								</td>
								...
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_seven_boys',
										'label' => false
										)); ?> 
									</div>
								</td>
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_eight_boys',
										'label' => false
										)); ?> 
									</div>
								</td>
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_nine_boys',
										'label' => false
										)); ?> 
									</div>
								</td>
								...
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_eleven_boys',
										'label' => false
										)); ?> 
									</div>
								</td>
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_twelve_boys',
										'label' => false
										)); ?> 
									</div>
								</td>
							...
							<tr>
								...
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_four_girls',
								...
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_five_girls',
										'class' => 'form-control repeaters-girls-calc'
										)); ?>
									</div>
								</td>
								...
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_six_girls',
										'class' => 'form-control repeaters-girls-calc'
										)); ?>
									</div> 
								</td>
								...
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_seven_girls',
										'label' => false
										)); ?> 
									</div>
								</td>
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_eight_girls',
										'label' => false
										)); ?> 
									</div>
								</td>
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_nine_girls',
										'label' => false
										)); ?> 
									</div>
								</td>
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_ten_girls',
										'label' => false
										)); ?> 
									</div>
								</td>
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_eleven_girls',
										'label' => false
										)); ?> 
									</div>
								</td>
								<td>
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'repeaters_class_twelve_girls',
										'label' => false
										)); ?> 
									</div>
								</td>
							...
							<tr>
								...
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'perm_class_ece_boys_absentees',
								...
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'perm_class_katchi_boys_absentees',
										'class' => 'form-control perm-abs-calc'
										)); ?>	
									</div>				
								</td>
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'perm_class_one_boys_absentees',
										'class' => 'form-control perm-abs-calc'
										)); ?>	
									</div>				
								</td>
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'perm_class_two_boys_absentees',
										'class' => 'form-control perm-abs-calc'
										)); ?>	
									</div>				
								</td>
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'perm_class_three_boys_absentees',
										'class' => 'form-control perm-abs-calc'
										)); ?>	
									</div>				
								</td>
							...
							<tr>
								...
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'perm_class_ece_girls_absentees',
								...
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'perm_class_katchi_girls_absentees',
										'class' => 'form-control perm-abs-girls-calc'
										)); ?>	
									</div>				
								</td>
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'perm_class_one_girls_absentees',
										'class' => 'form-control perm-abs-girls-calc'
										)); ?>	
									</div>				
								</td>
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'perm_class_two_girls_absentees',
										'class' => 'form-control perm-abs-girls-calc'
										)); ?>	
									</div>				
								</td>
								<td>			
									<div class="form-group col-xs-10" style="padding-left: 0; padding-right: 0;">
										...
										'maxlength' => '3',
										'size' => '3',
										'name' => 'perm_class_three_girls_absentees',
										'class' => 'form-control perm-abs-girls-calc'
										)); ?>	
									</div>				
								</td>
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="form-group col-md-2" id='consolidated_main_school_name' style="display: none;">
					...
					<div class="form-group col-md-2" id='consolidated_main_school_semis' style="display: none;">
	...
	<div class="row">
		<div class="panel panel-success">
			<div class="panel-heading">
				<h5 class="panel-title">24. Any <strong>construction work</strong> in the last academic year? [From the period of Oct 2014 to 2015]</h5>
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="form-group col-md-2">
	...
	<div class="row">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				...
				<div class="row" id="adopter_name_div" style="display: none;">
					<div class="form-group col-md-4">
...
<div id="page3" class="hide">
			...
			<div class="panel-body">
				<div class="row">
					...
					<!--<a type="button" href="javascript:teachers_add(id);" class="teachers_add">Add Another Teacher Details</a>-->
						...
						<button disabled="disabled" type="button" id="addrow" class="btn btn-primary" onclick="addRow('teachers_table')">Add Teacher</button>
					...
					<!--<a type="button" href="javascript:teachers_add(id);" class="teachers_add">Add Another Teacher Details</a>-->
						...
						<table id="merge_schools_table" class="table table-condensed table-bordered">
							...
							?>
								...
								<tr>
								<?= $this->Form->input('Asc201516sConsolidation.'.$key.'.campus_id', array('type' => 'hidden', 'value' => $value['semis_consolidation_univ201415s']['campus_id'])); ?>
									<td class="col-xs-2">
										<?= $key; ?>
									</td>
									<td class="col-xs-2">
										...
										'label'      => false,
										'type'       => 'text',		
										'value'      => $value['semis_consolidation_univ201415s']['bi_school_name'],	
										'onkeypress' => 'return isAlphabetKey(event)',
										'readonly'
										)); 
										?>
									...
									<td>
										...
										'maxlength'  => '9',
										'size'       => '9',
										'value'      => $value['semis_consolidation_univ201415s']['school_semis_new'],
										'onkeypress' => 'return isNumberKey(event)',
										'readonly'
										)); 
										?>
				...
				<div class="row">
					<div class="col-md-4">
						<?= $this->Form->input('upload1', array(
							...
							'class' => 'form-control'
						));//$this->Form->labelTag('File/image', 'Image');?>
	...
	$options = array(
	    'label' => 'Submit',
	    'class' => 'btn btn-primary'//array(
	        //'class' => 'btn btn-primary',
	    //)
	);
	echo $this->Form->end($options);
	//$this->Form->end('Submit', array('class' => 'btn btn-primary')); ?>	
</div>
