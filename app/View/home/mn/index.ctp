...
<?= $this->Form->create('mnform', array('url' => array('controller' => 'home', 'action' => 'add'), 'onsubmit'=> 'return verify(event);')); ?>
...
<div class="row">
	...
	<div class="form-group col-md-3" id="semis_code_div">
  	...
  	<div class="form-group col-md-2">
  		...
  		<?= $this->Form->button("Validate", array('type' => 'button', 'id' => 'validatesemis', 'class' => 'btn btn-primary', 'style' => 'margin-top: 23px;')); ?>
  	</div>	
</div>
<div id="SemisCodeResult">
...
<div class="row">
	<div class="form-group col-md-2">
  	...
  	<div class="form-group col-md-12" id="closure_major_reason_specify_div" style="display: none;">
  		<?= $this->Form->input('closure_major_reason_specify', array(
...
<div class="row">
	...
	<div class="form-group col-md-6">
		<?= $this->Form->input('dmname', array('label' => 'Data Monitor Name', 'placeholder' => 'Data Monitor Name', 
		'onkeypress' => 'return isAlphabetKey(event)',
		'class' => 'form-control')); ?>
	</div>
